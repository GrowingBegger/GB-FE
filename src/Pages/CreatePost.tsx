        ...
        <Container>
            ...
            <InputWrapper>
                ...
                <Input>
                    ...
                    <LoginInput placeholder="" value={price} onChange={(e) => setPrice(e.target.value)} isUnit={true} />
                </Input>
                <Input>
                    <Text>
                        <Name>지출명</Name>
                ...
                <Input>
                    ...
                    <Textarea onValueChange={(hasValue) => setContent(hasValue ? "valid" : "")} />{" "}
                </Input>
            </InputWrapper>
            <Button backgroundColor={isFormValid ? "orange" : "gray"} content="게시하기" disabled={!isFormValid} />
        </Container>
    );
};
